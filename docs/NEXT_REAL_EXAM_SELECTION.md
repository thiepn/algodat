...
## Abschluss `exam-2024-1`

Die neunseitige Klausurfassung von 2024 und ihre byteidentische Dublette wurden vollständig visuell geprüft und als sechste Sammlung kanonisiert. Die neun Aufgaben ergeben 50 Punkte. Semester, Datum, Dauer, Hilfsmittel, prüfende Person und offizielle Bezeichnung bleiben mangels belastbarer Angaben ausdrücklich unbekannt. Zwei wortgleiche spätere offizielle Übungslösungen stützen die Aufgaben 6 und 8; die übrigen sieben Lösungen sind transparent authored und deterministisch geprüft. Damit betrifft die nächste Auswahlentscheidung noch 33 offene Kandidaturen. [Klausur: `src-6df30a9ff1ae`, S. 1–9; Dublette: `src-ce97639c1821`, S. 1–9; Lösungen: `src-10a4e5432d36`, S. 3 und 7; `src-618e7da9bab3`, S. 1–3]

## Abschluss `exam-2021-1`

Die zunächst wegen einer falschen Lösungszuordnung zurückgestellte Erstklausur 2021 wurde als fünfte Sammlung vollständig kanonisiert. Ihre sechs Aufgaben, 60 Punkte und 120 Minuten bleiben als historische Ausnahmestruktur erhalten. Die falsche Lösungsquelle wurde nach vollständigem Vergleich aller 16 Seiten nicht verbunden; sämtliche sechs Lösungen sind transparent authored. Der damalige Stand von 42 offenen Kandidaturen ist durch `exam-2024-1` überholt. [Klausur: `src-28fe81380661`, S. 1–7; abweichende Quelle: `src-39eb3d94f40a`, S. 1–16]
...
| `exam-2024-1` | `src-6df30a9ff1ae`; byteidentische Dublette `src-ce97639c1821` in `dup-exact-5771ba7f1157` | Jahr 2024; Semester, Datum, Dauer, Hilfsmittel, prüfende Person und offizielle Bezeichnung unbekannt; 9 Aufgaben, 50 Punkte | Aufgaben 1–9 auf S. 1–9; wortgleiche spätere offizielle Übungslösungen zu Aufgaben 6 und 8 | Alle neun Seiten und alle benötigten visuellen Strukturen geprüft und zugänglich rekonstruiert | Abgeschlossen: Dublette versöhnt, sieben authored Lösungen und zwei verifizierte offizielle spätere Lösungen; Metadatenlücken bleiben transparent. [Klausur: `src-6df30a9ff1ae`, S. 1–9; Lösungen: `src-10a4e5432d36`, S. 3 und 7; `src-618e7da9bab3`, S. 1–3] |
